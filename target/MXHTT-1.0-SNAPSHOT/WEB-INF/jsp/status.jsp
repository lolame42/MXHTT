...
<div class="mains">
    <div class="full">
        ...
        <c:forEach var="allcomment" items="${allcomment}">
            <div class="comments">
                <a class="otb" href="<c:url value="/wall/${allcomment.logincmt.id}"/>"><img class="img-fluid" src="<c:url value="${allcomment.logincmt.image}" />" alt="${allcomment.logincmt.full_name}"/>  </a>
                <div class="comment"> 
