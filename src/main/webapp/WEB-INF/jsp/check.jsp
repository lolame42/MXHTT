...
<div class="main">
    ...
    <c:if test= "${err==null}">
        <h4 class="text-danger text-center">Thanh toán số tiền ${bill.value}k VND cho số điện thoại 
            ${bill.loginsell.phone} và nhập mã giao dịch để xác nhận đã thanh toán cho hóa đơn này</h4>
    </c:if>
    <c:if test= "${post!=null}">
